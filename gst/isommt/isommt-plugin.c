...
plugin_init (GstPlugin * plugin)
{
  ...
  gst_tag_register (GST_QT_DEMUX_PRIVATE_TAG, GST_TAG_FLAG_META,
      GST_TYPE_SAMPLE, "MMT atom", "unparsed MMT tag atom",
  ...
  if (!gst_element_register (plugin, "mmtdemux",
          GST_RANK_PRIMARY, GST_TYPE_MMTDEMUX))
    return FALSE;
...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR,
    GST_VERSION_MINOR,
    isommt,
    "ISO base media file format support (mmt)",
