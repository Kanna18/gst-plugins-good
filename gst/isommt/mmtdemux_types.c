...
static const QtNodeType qt_node_types[] = {
  ...
  {FOURCC_gmin, "base media info", 0, mmtdemux_dump_gmin},
  ...
  {FOURCC_dcom, "compressed data", 0, mmtdemux_dump_dcom},
  {FOURCC_cmvd, "compressed movie data", 0, mmtdemux_dump_cmvd},
  {FOURCC_hint, "hint", 0,},
  {FOURCC_mp4a, "mp4a", 0,},
  {FOURCC_mp4v, "mp4v", 0,},
  {FOURCC_mjp2, "mjp2", 0,},
  ...
  {FOURCC_jp2x, "jp2x", 0,},
  {FOURCC_alac, "alac", 0,},
  {FOURCC_fLaC, "fLaC", 0, mmtdemux_dump_fLaC},
  {FOURCC_dfLa, "dfLa", 0, mmtdemux_dump_dfLa},
  ...
  {FOURCC_rtp_, "rtp ", 0, mmtdemux_dump_unknown},
  {FOURCC_sdp_, "sdp ", 0, mmtdemux_dump_unknown},
  {FOURCC_meta, "meta", 0, mmtdemux_dump_unknown},
  ...
  {FOURCC_data, "data", 0, mmtdemux_dump_unknown},
  {FOURCC_free, "free", 0,},
  {FOURCC_skip, "skip", 0,},
  {FOURCC_SVQ3, "SVQ3", 0,},
  ...
  {FOURCC_ctts, "Composition time to sample", 0, mmtdemux_dump_ctts},
  {FOURCC_cslg, "Composition Shift Least Greatest", 0, mmtdemux_dump_cslg},
  {FOURCC_XiTh, "XiTh", 0},
  {FOURCC_XdxT, "XdxT", 0},
  {FOURCC_loci, "loci", 0},
  {FOURCC_clsf, "clsf", 0},
  ...
  {FOURCC_mfhd, "movie fragment header", 0, mmtdemux_dump_mfhd},
  ...
  {FOURCC_sdtp, "independent and disposable samples", 0,
      mmtdemux_dump_sdtp},
  {FOURCC_trun, "track fragment run", 0, mmtdemux_dump_trun},
  {FOURCC_mdat, "moovie data", 0, mmtdemux_dump_unknown},
  {FOURCC_trex, "moovie data", 0, mmtdemux_dump_trex},
  ...
  {FOURCC_tfdt, "Track fragment decode time", 0, mmtdemux_dump_tfdt},
...
const QtNodeType *
mmtdemux_type_get (guint32 fourcc)
{
  int i;
